# Promotions API OpenAPI Specification
[![Build Status](https://travis-ci.com/filipehcds/promotions-api.svg?branch=master)](https://travis-ci.com/filipehcds/promotions-api)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://filipehcds.github.io/promotions-api/)
- OpenAPI Raw Files: [JSON](https://filipehcds.github.io/promotions-api/openapi.json) [YAML](https://filipehcds.github.io/promotions-api/openapi.yaml)
